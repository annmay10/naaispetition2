  ...
  render() {
    return (
        <div className="App">
            ...
            <h3 className="ui header" style={{paddingLeft:10, paddingRight: 10}}>We need to protect the diversity at our institutions, to support the future of immigrant students, and to prevent international students from being denied their fundamental rights as members of this community. Asking your university to sue the Trump administration for their misguided policies is imperative to protect the globally acclaimed higher-level education system America prides itself upon.</h3>
